...
(function($) {
    ...
    $.fn.cluetip = function(js, options) {
        ...
        this.each(function(index) {
        	...
        	//保留一个没有截取过的title的注释，用于在页面上显示
            var titlename=tipTitle;
            if (opts.splitTitle) {
...
//activate clueTip
            var activate = function(event) {
                ...
                // activate function may    called after an initialization of a
...
// (first hide, then) ***SHOW THE CLUETIP***
            ...
            var cluetipClose = function(el) {
                ...
                if (ct && tipTitle) {
                	//title的注释要没截取过的
                    $closer.attrProp(opts.titleAttribute, titlename);
